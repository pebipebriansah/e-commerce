        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                ...
                ?>
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('pegawai/barang/update/').$barang['id_produk']?>" method="POST">
                            <?= csrf_field()?>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="id_produk" class="form-control" readonly required=""
                                            value="<?=$barang['id_produk']?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Nama Produk</label>
                                        <input type="text" name="nama_produk" class="form-control" required="" value="<?=$barang['nama_produk']?>">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="keterangan" class="form-control" value="<?=$barang['keterangan']?>"><?=$barang['keterangan']?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Photo</label>
                                        <input type="file" class="form-control" name="photo" value="<?=$barang['photo']?>"><?=$barang['photo']?>
                                    </div>
                                </div>
