        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                ...
                ?>
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('pegawai/customer/update/').$customer['id_customer']?>" method="POST">
                            <?= csrf_field()?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_customer" class="form-control" required="" value="<?=$customer['nama_customer']?>"> 
                                <div class="valid-feedback">
                                    Good job!
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tempat_tinggal" class="form-control" value="<?=$customer['tempat_tinggal']?>">
                            </div>
                            <div class="form-group">
                                <label>No Hp</label>
                           ...
                           <div class="form-group">
                                <label>Point</label>
                                <input type="text" name="point" class="form-control" value="<?=$customer['point']?>">
                           </div>
